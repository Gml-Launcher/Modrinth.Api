...
public class Versions
{
    ...
    public async Task<IReadOnlyCollection<Version>> GetVersionsByModId(string identifier, string loader,
        string gameVersion, CancellationToken token)
    {
        ...
        if (!response.IsSuccessStatusCode) return Array.Empty<Version>();
